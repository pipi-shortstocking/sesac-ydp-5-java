...
public class GenericEx01 {
	...
	public static void main(String[] args) {
		...
		gLi.addElement(9);
		gLi.addElement(12);
		System.out.println(gLi.toString()); // CustomListGeneric = [3, 6, 9, 12]
		
		gLi.removeElement(9);
		System.out.println(gLi.toString()); // CustomListGeneric = [3, 6, 12]
		...
		gLi2.addElement('D');
		gLi2.addElement('E');
		System.out.println(gLi2.toString()); // CustomListGeneric = [A, B, C, D, E]
		
		gLi2.removeElement('D');
		System.out.println(gLi2.toString()); // CustomListGeneric = [A, B, C, E]
