...
// - 컬렉션 객체는 기본 타입 값을 지정할 수 없어서 Wrapper 객체를 사용 
...
public class BoxingUnboxingEx {
	...
	public static void main(String[] args) {
		...
		System.out.printf("double value: %.2f%n", obj2.doubleValue()); // doubleValue(): Double 객체 내부의 double 값 리턴
		System.out.println();
		...
		// 연산 시 boxing 
		int result = obj1 + 1; // obj1인 primitive type 인 1과 연산되기 전에 언박싱 됨 
